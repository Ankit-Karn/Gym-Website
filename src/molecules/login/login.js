...
const Login = () => {
  ...
  return (
    <div className={styles.loginMian}>
     <img className={styles.sideimg} src="https://arogyaminstitute.com/wp-content/uploads/2022/11/nutrition-in-sports-3-min-scaled.webp" alt="demo"  />
        ...
        <h1>Login</h1>
          ...
          <h3>
          Don't have an account? <span className={styles.spanlogin} onClick={()=> Navigate('/signup')}>Register</span>
        </h3>
        <h1>{isUser}</h1>
        </form>
