  ...
  return (
    <div className={styles.main} >
      ...
      <h1>Register yourself</h1>
        ...
        <h3>
        Already have an account? <span className={styles.spanlogin} onClick={() => navigate("/login")}>Login</span>
      </h3>
      <h2>{isuserPresent ? "User Already exits please login" : ""}</h2>
      <h2>{isregister ? "Registration succesfully" : ""}</h2>
      </form>
      <div>
      <img className={styles.sideimg} src="https://thumbs.dreamstime.com/b/portrait-two-young-fit-sporty-people-crossed-hands-happy-sporty-couple-159211709.jpg" alt="demo"  />
     </div>
